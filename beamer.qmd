...
author: Laura Boehm Vock and Paul Roback \newline \newline github.com/proback/USCOTS25_Poisson_breakout
format: 
  beamer:
...
-   Our reponse variables are *counts*, which can make linear regression problematic
...
total_dist <- ggplot(fHH1, aes(total)) + 
  geom_histogram(binwidth = .25, 
                 color = "black", 
                 fill = "white") + 
  xlab("# in house excluding head of household") +
  ylab("Count of households") +
  facet_wrap(~location) +
  geom_text(data = textdat, aes(x = 10, y = 90, label = Mean), size = 8)
...
age_vs_total <- ggplot(sumStats, aes(x=age, y=logmntotal)) +
  ...
  xlab("Age of head of the household") +
  ylab("Log mean number in the house") 
...
How would the plots above inform your modeling?
...
\small
For example, $\hat{\beta}_5= 0.112$ indicates that, after controlling for the age of the head of household, the log mean household size is 0.112 higher for households in the Visayas Region than for households in the reference location of Central Luzon. 

In more interpretable terms, mean household size is $e^{0.112}=1.12$ times higher (i.e., 12\% higher) in the Visayas Region than in Central Luzon, when holding age constant.  
...
final_qp + theme(axis.title.x = element_text(size = 30, face = "bold"),
                 axis.title.y = element_text(size = 30, face = "bold"),
        axis.text = element_text(size = 20))

final_nb + theme(axis.title.x = element_text(size = 30, face = "bold"),
                 axis.title.y = element_text(size = 30, face = "bold"),
        axis.text = element_text(size = 20))
...
count_dist + theme(axis.title.x = element_text(size = 40, face = "bold"),
                 axis.title.y = element_text(size = 40, face = "bold"),
        axis.text = element_text(size = 25))

count_by_year + theme(axis.title.x = element_text(size = 40, face = "bold"),
                 axis.title.y = element_text(size = 40, face = "bold"),
        axis.text = element_text(size = 25))

obs_by_year + theme(axis.title.x = element_text(size = 40, face = "bold"),
                 axis.title.y = element_text(size = 40, face = "bold"),
        axis.text = element_text(size = 25))
...
But Poisson should model *counts*...

## Offsets

We let $\lambda_i$ be the expected number of eagles in year $i$ per with $\textrm{weeks}_i$ weeks observed in year $i$. 

Then $\lambda_i/\textrm{weeks}_i$ is a rate: the number of eagles expected per week!
...
g_obs + theme(axis.title.x = element_text(size = 30, face = "bold"),
                 axis.title.y = element_text(size = 30, face = "bold"),
        axis.text = element_text(size = 20))

g_model + theme(axis.title.x = element_text(size = 30, face = "bold"),
                 axis.title.y = element_text(size = 30, face = "bold"),
        axis.text = element_text(size = 20))
```
...
- Poisson regression is a natural extension of multiple linear and logistic regression

- Introduce students to the generalized linear model framework

- Many cool extensions! Helps students see that statistical models can be "tweaked", that it is  a growing and changing field

- Can be made accessible! Our class has no math or prob background, only applied statistics pre-requisites


## Preview of materials

github.com/proback/USCOTS25_Poisson_breakout
...
bookdown.org/roback/bookdown-BeyondMLR
